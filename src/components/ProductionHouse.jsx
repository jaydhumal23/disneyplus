...
export default function ProductionHouse() {
    ...
    return (
        <div className=''>
            <div className='flex gap-7 px-8 p-2 '>
                {list.map((data) => (
                    <div key={data.id} className='border-2 border-gray-500 rounded-xl trasition-all duration-[0.5s] hover:scale-110 curosr-pointer overflow-hidden shadow-xl shadow-gray-800 relative'>
